...
1. 在 **turbine-01** 刀鋒視窗上，按一下 **[主索引鍵]** 右側的 **[複製]**，然後儲存該值，以供稍候使用。
    ...
    ![Azure IoT 安全性模組的螢幕擷取畫面](media/LAB05_module-identity.png)
...
1. 在 Azure 入口網站工具列上，按一下 **[Cloud Shell]**。![](media/cloudshell01.png)
...
1. 請注意，在 **[模組身分識別]** 下的 **azureiotsecurity** 模組，現在處於 **[Connected (已連線)]** 狀態，
    ...
    ![Azure IoT 安全性模組已連線的螢幕擷取畫面](media/azuresecurity.png)
...
1. 在左側功能表的 **[安全性]** 下，按一下 **[概觀]**。 
    ...
    ![Azure IoT 安全性模組的螢幕擷取畫面](media/LAB_AK_05-security-dashboard.png)
...
1. 在左側功能表的 **[安全性]** 下，按一下 **[概觀]**。
    ...
    ![裝置安全性警示圖表](media/LAB_AK_05-device-security-alert-chart.png)
...
1. 在 **[Threat detection (威脅偵測)]** 下，按一下 **[Devices with the most alerts (警示最多的裝置)]** 磚。
    ...
    ![安全性警示清單](media/device_security_alert.png)
